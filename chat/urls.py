...
urlpatterns = [
    ...
    path("conversations/load-more/", views.load_more_conversations, name="load_more_conversations"),
    path("conversations/search/", views.search_conversations, name="search_conversations"),
    path("live-intelligence/", views.live_intelligence_feed, name="live_intelligence"),
    path("live-intelligence/refresh/", views.live_intelligence_refresh, name="live_intelligence_refresh"),
