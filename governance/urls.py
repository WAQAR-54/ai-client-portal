...
urlpatterns = [
    ...
    path(
        "feature-visibility/google-signin/toggle/",
        views.toggle_google_signin_enabled,
    ...
    path("plans/manage/<int:plan_id>/", views.PlanManageView.as_view(), name="plan_manage"),
    path("plans/manage/<int:plan_id>/access/update/", views.update_plan_access, name="update_plan_access"),
    ...
    path("media/bulk-delete/", media_views.media_bulk_delete, name="media_bulk_delete"),
    path("media/bulk-selectable/", media_views.media_bulk_selectable, name="media_bulk_selectable"),
    path("media/orphans/<str:token>/", media_views.media_view_orphan, name="media_view_orphan"),
    path("media/orphans/<str:token>/preview/", media_views.media_preview_orphan, name="media_preview_orphan"),
    path("media/orphans/<str:token>/download/", media_views.media_download_orphan, name="media_download_orphan"),
    path("media/<str:source>/<int:pk>/", media_views.media_view, name="media_view"),
